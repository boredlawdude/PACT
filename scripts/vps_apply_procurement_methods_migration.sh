...
# Applies the procurement_methods migration on the VPS using DB credentials
# from the app .env file.
#
# Usage on VPS:
#   bash scripts/vps_apply_procurement_methods_migration.sh
#
# Optional overrides:
#   APP_DIR=/var/www/contracts_app MIGRATION_FILE=procurement_methods_migration.sql bash scripts/vps_apply_procurement_methods_migration.sh
