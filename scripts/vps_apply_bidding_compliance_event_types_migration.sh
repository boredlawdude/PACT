...
# Applies the bidding_compliance_event_types migration on the VPS using DB
# credentials from the app .env file.
#
# Usage on VPS:
#   bash scripts/vps_apply_bidding_compliance_event_types_migration.sh
#
# Optional overrides:
#   APP_DIR=/var/www/contracts_app MIGRATION_FILE=bidding_compliance_event_types_migration.sql bash scripts/vps_apply_bidding_compliance_event_types_migration.sh

APP_DIR="${APP_DIR:-/var/www/contracts_app}"
MIGRATION_FILE="${MIGRATION_FILE:-bidding_compliance_event_types_migration.sql}"
