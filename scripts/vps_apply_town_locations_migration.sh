...
# Applies the town_locations migration on the VPS using DB credentials
# from the app .env file.
#
# Usage on VPS:
#   bash scripts/vps_apply_town_locations_migration.sh
#
# Optional overrides:
#   APP_DIR=/var/www/contracts_app MIGRATION_FILE=town_locations_migration.sql bash scripts/vps_apply_town_locations_migration.sh

APP_DIR="${APP_DIR:-/var/www/contracts_app}"
MIGRATION_FILE="${MIGRATION_FILE:-town_locations_migration.sql}"
