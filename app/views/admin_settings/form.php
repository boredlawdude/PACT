    ...
    <div class="card shadow-sm mb-4">
        ...
        <div class="card-body">
            <div class="row g-3">
                ...
                <div class="col-6 col-md-3">
                    <a href="/index.php?page=admin_document_categories" class="btn btn-outline-primary w-100">Document Categories</a>
                </div>
                <div class="col-6 col-md-3">
                ...
                <div class="col-6 col-md-3">
                    <a href="/index.php?page=admin_town_locations" class="btn btn-outline-primary w-100">Town Locations</a>
                </div>
                <div class="col-6 col-md-3">
