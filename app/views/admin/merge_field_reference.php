      ...
      <table class="table table-sm table-bordered table-hover mb-0">
        ...
        <tbody>
          ...
          $contractFields = [
            ...
            ['procurement_method',       'Procurement method short description (e.g. Competitive Bid (IFB)) — managed under Procurement Methods admin'],
            ['procurement_method_id',    'Internal numeric ID of the selected procurement method'],
      ...
      <table class="table table-sm table-bordered table-hover mb-0">
        ...
        <tbody>
          ...
          $partyFields = [
            ...
            ['town_contact_name',                'Town Contact person\'s full name (from the Town Contact dropdown)'],
            ['town_contact_email',               'Town Contact person\'s email address'],
            ['town_contact_office_phone',        'Town Contact person\'s office phone number'],
            ['town_contact_cell_phone',          'Town Contact person\'s cell phone number'],
            ['town_contact_address',             'Town Contact\'s mailing address (uses the owner/municipality company\'s address)'],
