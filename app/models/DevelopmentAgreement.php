...
class DevelopmentAgreement
{
    ...
    public function all(): array
    {
        $stmt = $this->db->query("
            SELECT
                ...
                da.created_at,
                da.developer_entity_name,
                da.developer_contact_name,
    ...
    public function update(int $id, array $data): void
    {
        $stmt = $this->db->prepare("
            UPDATE development_agreements SET
                ...
                developer_entity_name           = :developer_entity_name,
                developer_contact_name          = :developer_contact_name,
                developer_address               = :developer_address,
                developer_phone                 = :developer_phone,
                developer_email                 = :developer_email,
                developer_state_of_incorporation = :developer_state_of_incorporation,
                developer_entity_type           = :developer_entity_type,
    ...
    private function bindParams(array $data): array
    {
        ...
        return [
            ...
            ':property_owner_name'            => $nullOrStr($data['property_owner_name'] ?? null),
            ':developer_entity_name'          => $nullOrStr($data['developer_entity_name'] ?? null),
            ':developer_contact_name'         => $nullOrStr($data['developer_contact_name'] ?? null),
            ':developer_address'              => $nullOrStr($data['developer_address'] ?? null),
            ':developer_phone'                => $nullOrStr($data['developer_phone'] ?? null),
            ':developer_email'                => $nullOrStr($data['developer_email'] ?? null),
            ':developer_state_of_incorporation' => $nullOrStr($data['developer_state_of_incorporation'] ?? null),
            ':developer_entity_type'          => $nullOrStr($data['developer_entity_type'] ?? null),
